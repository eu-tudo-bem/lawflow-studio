...
const ExecucaoPensao = () => {
  usePageSEO({
    ...
    description: "Ele parou de pagar a pensão? Saiba como a lei pode forçar o pagamento através de prisão civil, bloqueio de contas e desconto em salário. Fale com um especialista.",
  });

  const whatsappLink = "https://wa.me/5541999999999?text=Olá, preciso de ajuda urgente para cobrar pensão alimentícia atrasada.";
      ...
      <main className="pt-20">
        ...
        <section className="bg-slate-950 text-white py-16 md:py-28 px-4 relative overflow-hidden">
          ...
          <div className="container mx-auto max-w-5xl relative z-10 text-center">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-bold mb-6 leading-tight tracking-tight">
              ...
              <span className="text-rose-500 underline decoration-rose-600 underline-offset-8">A lei está do seu lado.</span>
            </h1>
            
            <p className="text-xl md:text-2xl text-slate-300 mb-10 max-w-3xl mx-auto font-light">
              Desculpas não pagam o supermercado. Pare de implorar pelo que é direito do seu filho. Atuamos com <strong className="text-white font-semibold">medidas drásticas</strong> para forçar o pagamento imediato.
            </p>
        ...
        <section className="py-20 container mx-auto px-4">
          <div className="text-center mb-16">
            <span className="text-rose-700 font-bold tracking-wider uppercase text-sm mb-2 block">Nosso Arsenal Jurídico</span>
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-slate-900 mb-4">Como forçamos o devedor a pagar</h2>
            <p className="text-slate-600 text-lg max-w-2xl mx-auto">A lei brasileira é extremamente rigorosa com quem não paga pensão. Usamos todos os meios legais disponíveis.</p>
          </div>
            ...
            <Accordion type="single" collapsible className="w-full bg-white rounded-2xl shadow-sm border border-slate-200 p-2">
              <AccordionItem value="item-1" className="border-b-0">
                <AccordionTrigger className="text-left font-bold text-lg px-4 hover:text-rose-700">
                  Ele está desempregado. Posso cobrar mesmo assim?
                </AccordionTrigger>
                <AccordionContent className="text-slate-600 text-base px-4 pb-4">
                  SIM! O desemprego não cancela a obrigação de pagar a pensão alimentícia. Enquanto ele não entrar com um pedido de revisão e o juiz não autorizar, a pensão continua correndo e ele pode ser preso pelos atrasos.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-2" className="border-b-0">
                ...
                <AccordionContent className="text-slate-600 text-base px-4 pb-4">
                  Apenas 1 mês de atraso já é suficiente para darmos entrada no pedido de execução sob pena de prisão civil. Não é necessário esperar acumular 3 meses.
                </AccordionContent>
              </AccordionItem>
              <div className="h-px bg-slate-100 mx-4" />
              <AccordionItem value="item-3" className="border-b-0">
                <AccordionTrigger className="text-left font-bold text-lg px-4 hover:text-rose-700">
                  O valor foi combinado de boca. Posso executar?
                </AccordionTrigger>
                <AccordionContent className="text-slate-600 text-base px-4 pb-4">
                  Não. Para "executar" (mandar prender ou penhorar bens) a pensão precisa estar fixada por um Juiz. Se o acordo foi só "de boca", o primeiro passo é entrarmos com a Ação de Fixação de Alimentos. Nós fazemos isso de forma muito rápida.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
          ...
          <div className="bg-rose-700 rounded-[2rem] p-8 md:p-16 relative shadow-2xl overflow-hidden border-4 border-rose-600">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-rose-100 mb-10 max-w-2xl mx-auto font-medium">
                Clique no botão abaixo. Uma de nossas advogadas vai ouvir o seu caso com total sigilo e iniciar a cobrança judicial imediatamente.
              </p>
