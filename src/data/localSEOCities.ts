...
export const LEGAL_SERVICES: ServiceData[] = [
  ...
  },
  {
    ...
    name: "Contratos de Arrendamento Rural",
    shortName: "Arrendamento",
    icon: "📄",
    keyword: "arrendamento-rural",
    area: "Direito Agrário",
  },
  {
    slug: "reintegracao-posse",
    name: "Reintegração de Posse de Terras",
    shortName: "Posse",
    icon: "🛡️",
  ...
  },
  {
    ...
    name: "Regularização de Imóveis Rurais",
    shortName: "Matrícula Rural",
    icon: "🗺️",
    keyword: "regularizacao-rural",
    area: "Direito Agrário",
  },
];

export const PARANA_CITIES: CityData[] = [
  // Lote 1 e 2 (46 Cidades Iniciais)
  {
    slug: "curitiba",
    name: "Curitiba",
...
export const textVariations = {
  subtitle: [
    ...
    (city: string, region: string) =>
      `Soluções jurídicas para quem está em ${city}. Atendemos presencialmente e de forma online em todo o ${region}.`,
  ],
  attendanceText: [
    (city: string) =>
...
export const serviceTextVariations: Record<string, any> = {
  ...
  "arrendamento-rural": {
    intro: [
      (city: string) =>
        `Proteja a sua produção em ${city}. Especialistas em contratos de arrendamento rural e parcerias agrícolas para garantir os direitos de arrendadores e arrendatários.`,
    ],
    situations: [
      (city: string) => [
        `Renovação automática de contrato em ${city}`,
        `Despejo rural por falta de pagamento`,
        `Discussão de percentagem da colheita`,
      ],
    ],
    howItWorks: [
      (city: string) =>
        `Analisamos o Estatuto da Terra e as cláusulas do seu contrato em ${city} para evitar prejuízos na safra ou na posse.`,
    ],
    whenToLook: [
      (city: string) =>
        `Procure-nos 6 meses antes do fim do contrato em ${city} ou se houver descumprimento de cláusulas de pagamento.`,
    ],
    conclusion: [
      (city: string) => `Segurança jurídica para quem produz. Garanta o seu contrato em ${city} hoje mesmo.`,
    ],
  },
  "reintegracao-posse": {
    intro: [
      (city: string) =>
        `Sua terra em ${city} foi invadida ou está sofrendo turbação? Atuamos com urgência em ações de reintegração de posse para produtores rurais.`,
    ],
    situations: [
      (city: string) => [
        `Invasão de propriedade rural em ${city}`,
        `Conflitos de divisa com vizinhos`,
        `Ameaça à posse da terra agrícola`,
      ],
    ],
    howItWorks: [
      (city: string) =>
        `Ingressamos com pedido de liminar em ${city} para recuperação imediata da posse, documentando o esbulho e a propriedade.`,
    ],
    whenToLook: [
      (city: string) => `Aja rápido! Assim que detectar a invasão ou ameaça em ${city}, a agilidade jurídica é vital.`,
    ],
    conclusion: [(city: string) => `Proteja o seu maior património. Recuperamos a posse da sua terra em ${city}.`],
  },
  "regularizacao-rural": {
    intro: [
      (city: string) =>
        `Imóvel rural em ${city} sem matrícula ou com documentação pendente? Regularizamos o seu património junto ao INCRA e Registro de Imóveis.`,
    ],
    situations: [
      (city: string) => [
        `Imóvel rural sem escritura em ${city}`,
    ...
    howItWorks: [
      (city: string) =>
        `Realizamos a auditoria documental na região de ${city} e conduzimos o processo de retificação ou usucapião rural.`,
    ],
    whenToLook: [
      (city: string) =>
        `Se pretende vender, financiar a safra ou deixar herança em ${city}, a regularização é obrigatória.`,
    ],
    conclusion: [
      (city: string) => `Terra regularizada vale mais. Valorize a sua propriedade em ${city} com documentação em dia.`,
    ],
  },
};
