Aqui está o código do seu `App.tsx` atualizado com base na versão que enviou, já com a importação e a rota da **Execução de Pensão Alimentícia** adicionadas no sítio certo.

Basta copiar e substituir tudo:
